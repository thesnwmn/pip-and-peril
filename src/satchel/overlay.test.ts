...
describe('createSatchelOverlay — draw tabs', () => {
  ...
  it('draws pouch with items without throwing', () => {
    ...
    const inventory: Inventory = {
      gold: 5,
      items: [
        { id: 'cheese-1', name: 'Cheese', iconType: 'cheese', quantity: 1, description: 'Restores 2 HP.' },
        { id: 'charm-1',  name: 'Charm',  iconType: 'charm',  quantity: 3, description: 'One free reroll.' },
      ],
    }
    overlay.open()
