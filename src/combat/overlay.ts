...
// Intent overlay — upper portion of enemy side.
...
// Draws HP bars for Pip and the enemy, plus the intent icon, over the map zone.
export function drawCombatOverlay(
  ...
  // ── Intent overlay (scrim pill + icon + value) ────────────────────────────
